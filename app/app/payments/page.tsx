    ...
    <>
      {
        ...
        */
          ...
          // -- BarLoader component --
         txnInProgress && <div className="bg-neutral-900/50 backdrop-blur absolute top-0 bottom-0 left-0 right-0 z-50 m-auto flex items-center justify-center">
      ...
      <>
        {
          ...
          */
          ...
          !isLoading &&
            connected &&
            network && 
            network.name.toString() != "Mainnet" && <Alert variant="destructive" className="w-fit mb-2 mr-2">
