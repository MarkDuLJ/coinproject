  ...
  */
  const startStream = async () => {
   ...
   const payload: Types.TransactionPayload = {
    ...
    // function: `${address}::${process.env.MODULE_NAME}::create_stream}`, // The address::module::function to call
    function: `${process.env.MODULE_ADDRESS}::${process.env.MODULE_NAME}::create_stream}`, // The address::module::function to call
    ...
    */
        try {
          ...
          console.log("STREAM_CREATOR: ",result);
